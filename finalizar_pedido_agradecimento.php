        ...
        <div class="container" >
            ...
            <div class="row">
                <div class="col-md-12 align-items-center">
                    <h1 style="text-align: center;"><strong style="border-bottom: 3px solid black;">Obrigado pelo pedido!</strong></h1>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <div style="text-align: center;">
                        <h2>Em breve um de nossos anões irá até seu endereço para entregar seu pedido. Obrigado pela preferência!</h2>
                    </div>
                    <div style="text-align: center;">
                        <a type="button" class="btn btn-search mt-5" href="pedidos.php">Ir para seus pedidos</a>
                    </div>
                </div>                
            </div>
