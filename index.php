    ...
    <header>
        <nav class="navbar navbar-expand-lg nav-bg navbar-dark"><!--data-bs-theme="dark"-->
            <div class="container-fluid">
                <a class="navbar-brand me-5 ms-5" href="index.php">BARÛK ALKH</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   ...
                   <!-- <form class="d-flex" role="search">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                       ...
                       <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle me-4" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <i class="fa-solid fa-right-to-bracket fa-xs me-1"></i> Conta </a>
                            <?php
                                if($logado == 1){
                        ...
                        <li class="nav-item">
                            <a class="nav-link me-5" href="carrinho.php"><i class="fa-solid fa-cart-shopping fa-xs me-1"></i> Geladeira </a>
                        </li>
                    </ul>
                </div>
            </div>
